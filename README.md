...
**SimpleVote** is a lightweight Minecraft Paper 26.3 plugin that rewards players with tokens when they vote for your server on voting websites. Although it was custom built for [minecraftoffline.net](https://www.minecraftoffline.net), any server can use it.
